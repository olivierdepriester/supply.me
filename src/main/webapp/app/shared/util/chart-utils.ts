export const COLORS_SETS: ColorSet[] = [
    {
        name: 'vivid',
        selectable: true,
        group: 'Ordinal',
...
export const DEFAULT_COLOR_SET = 'horizon';
...
export default class ChartUtils {
    public static getColorSet(colorSetName: string): ColorSet {
        console.log(COLORS_SETS);
        return COLORS_SETS.find(s => s.name === colorSetName);
    }

    public static getDefaultColorSet(): ColorSet {
        return this.getColorSet(DEFAULT_COLOR_SET);
    }

    public static getDefaultSchemeType(): string {
        return 'ordinal';
    }
}
