    ...
    describe('DeliveryNote Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/delivery-notes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DeliveryNote', () => {
                service.create(new DeliveryNote(null)).subscribe(received => {
            ...
            it('should update a DeliveryNote', () => {
                service.update(new DeliveryNote(123)).subscribe(received => {
            ...
            it('should return a DeliveryNote', () => {
            ...
            it('should return a list of DeliveryNote', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DeliveryNote(123)]);
            });
