...
import { IDemand, Demand, DemandStatus } from 'app/shared/model/demand.model';
...
describe('Service Tests', () => {
    describe('Demand Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Demand(0, 'PR', 0, DemandStatus.NEW, 'description', currentDate, currentDate);
        });
