    ...
    describe('InvoiceLine Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a InvoiceLine', () => {
                service.create(new InvoiceLine(null)).subscribe(received => {
            ...
            it('should update a InvoiceLine', () => {
                service.update(new InvoiceLine(123)).subscribe(received => {
            ...
            it('should return a InvoiceLine', () => {
