...
import { MaterialCategoryComponent } from 'app/entities/material-category/material-category.component';
...
describe('Component Tests', () => {
    describe('MaterialCategory Management Component', () => {
        let comp: MaterialCategoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MaterialCategoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.materialCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
