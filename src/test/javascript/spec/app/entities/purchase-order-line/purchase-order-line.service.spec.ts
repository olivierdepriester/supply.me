...
describe('Service Tests', () => {
    describe('PurchaseOrderLine Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new PurchaseOrderLine(0, 0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PurchaseOrderLine', async () => {
                ...
                service
                    .create(new PurchaseOrderLine(null))
                    .pipe(take(1))
            ...
            it('should update a PurchaseOrderLine', async () => {
                const returnedFromService = Object.assign(
                    {
                        lineNumber: 1,
                        quantity: 1,
            ...
            it('should return a list of PurchaseOrderLine', async () => {
                const returnedFromService = Object.assign(
                    {
                        lineNumber: 1,
                        quantity: 1,
            ...
            it('should delete a PurchaseOrderLine', async () => {
