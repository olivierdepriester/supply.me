    ...
    describe('PurchaseOrderLine Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a PurchaseOrderLine', () => {
                service.create(new PurchaseOrderLine(null)).subscribe(received => {
            ...
            it('should update a PurchaseOrderLine', () => {
                service.update(new PurchaseOrderLine(123)).subscribe(received => {
            ...
            it('should return a PurchaseOrderLine', () => {
            ...
            it('should return a list of PurchaseOrderLine', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PurchaseOrderLine(123)]);
            });
