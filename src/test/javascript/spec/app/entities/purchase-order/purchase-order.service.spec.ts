    ...
    describe('PurchaseOrder Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a PurchaseOrder', () => {
                service.create(new PurchaseOrder(null)).subscribe(received => {
            ...
            it('should update a PurchaseOrder', () => {
                service.update(new PurchaseOrder(123)).subscribe(received => {
            ...
            it('should return a PurchaseOrder', () => {
            ...
            it('should return a list of PurchaseOrder', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PurchaseOrder(123)]);
            });
